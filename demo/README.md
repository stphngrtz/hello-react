# Demo
Eine React Demo inkl. Routing und Redux, erstellt mit [Create React App](https://github.com/facebookincubator/create-react-app). Die Demo orientiert sich grundsätzlich am [Beispiel aus der React Advanced Dokumentation](http://redux.js.org/docs/advanced/ExampleRedditAPI.html), erweitert um die Details für das Routing.

Der folgende Text kommt aus dem Create React App Template...
